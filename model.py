...
class SomQnnCD:
    ...
    def train_unsupervised(self, epochs=50, epochs_som=500, epochs_net=500, threshold=0.9, is_x_y=True):
        """
        训练模型
        Args:
...
if __name__ == '__main__':
    ...
    # Q = pd.read_csv('./data/frac_sub_20_8/q_20_8.csv').iloc[:,1:].values
    # orp = pd.read_csv('./data/frac_sub_20_8/orp.csv').iloc[:,1:].values
